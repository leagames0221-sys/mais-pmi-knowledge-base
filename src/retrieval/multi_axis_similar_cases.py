"""5 dim weighted similarity detector
...
- 段階 3: 該当なし
 ...
 PatternWeight schema 順守 (industry 0.30 / culture 0.25 / size 0.20 / integration_type 0.15 / financial 0.10)。
...
# ordinal distance step → similarity score table
...
def _categorical_score(
    ...
    """categorical one-hot match score。
...
def compute_similarity(
    ...
    """5 dim weighted similarity。

    Raises:
        ValueError: weight sum が 1.0 ± 1e-6 範囲外
    """
