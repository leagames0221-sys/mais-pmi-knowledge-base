...
import 禁止: ontology / retrieval / assistant / integration / pipeline / operational / citation / api / llm は本 module literal import 禁止 (module boundary check、 systemPatterns.md SSoT)。
"""
from .store import (
    decrypt_from_vault,
    emit_audit,
