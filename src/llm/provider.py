"""LLMProvider Protocol SSoT (internal ADR § 6 順守、 T4 src/llm/ inherit pattern、 2026-05-14 起草)
...
class LLMProvider(Protocol):
    """3-method Protocol (internal ADR § 6 順守、 T4 SSoT inherit)"""
...
class ClaudeProvider:
    ...
    def _get_client(self) -> object:
        ...
        try:
            ...
            raise RuntimeError(
                "anthropic SDK not installed (Week 1 requirements 既 pin、 internal ADR § 6)。 "
