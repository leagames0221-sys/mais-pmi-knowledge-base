"""tests for src/orchestrator/build_state_graph.py (internal ADR § 4 + § 7 順守、 17 test)"""
...
def test_default_max_hops_3():
    """internal ADR § 4 + doctrine: consumer-hw + internal ontology 既存設定。"""
...
def test_multi_hop_weight_decay_numeric():
    """hop k weight = 1.0 × decay^k × edge_confidence、 internal ADR § 4 数値精度 verify。"""
    g = _build_chain_graph()
