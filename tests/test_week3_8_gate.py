"""tests for 8 gate full verify protocol
...
def test_gate1_eval_set_exists():
    """val_v1.jsonl literal 存在 verify。"""
...
def test_gate8_link_types_6_enum():
    """ link_types 6 enum 固定 (relationship 強制 mapping rule)。"""
...
def test_eight_gate_protocol_documented():
    """8 gate full verify protocol 各 gate の identification 整合性。"""
    expected_gates = {
